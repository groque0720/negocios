					...
					<div class="zona-producto">
						...
						<div class="form-linea">
							<div class="form-columna">
								...
								<textarea class="form-textarea" name="" id="" cols="30" rows="5" v-model='producto.descripcion' placeholder="Ingrese una breve descripción del producto"></textarea>
							</div>
						</div>
            ...
            <div class="form-foot p-t-10">
	            <div class="form-linea flex flex-space-between flex-item-center" >
	                <div class="form-columna m-b-0">
	                    <button class="btn form-btn-cancelar cursor p-l-20 p-r-20" @click.prevent="irProductos()">Cancelar</button>
	                </div>
	                <div class="form-columna m-b-0">
